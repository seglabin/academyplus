...
// Variables gloales
 $orientatione = isset($_SESSION["orientationpage"])?$_SESSION["orientationpage"]:'p';
$tab = isset($_SESSION["hautdoc"])? $_SESSION["hautdoc"]:array();
$th = isset($_SESSION['tailHaut'])? $_SESSION['tailHaut']:array();
$hl = isset($_SESSION['hauteurligne'])? $_SESSION['hauteurligne']:null;



// Instanciation de la classe dérivée
$pdf = new PDF($orientatione, 'mm', 'A4');
$pdf->AliasNbPages();
$pdf->AddPage();
