...
class PDFb1 extends FPDF {

// En-tête
    function Header() {
        // Logo DirectStock
//        $this->Image('../images/enteteSipec.png', 5, 5, largeur, hauteur);
        $this->Image('../img/entete.jpg', 20, 5, 170, 20);
...
//       $this->SetDrawColor(102, 405, 145);
       if($_SESSION["titre"]!='') $this->MultiCell(150, 5, utf8_decode($_SESSION["titre"]), 0, 'J', FALSE);
        ...
        $this->MultiCell(0, -35, utf8_decode('Année Scolaire : '. $_SESSION["libannesco"]), 0, 'R', FALSE);
...
// Pied de page
    function Footer() {
        ...
        // Numéro de page
        $this->Cell(0, 10, 'Copyright OMS' . date('Y') , 0, 0, 'R');
    }
     ...
     * $header
     */
    function FancyTabled($header, $headerBD, $data, $w, $border = 0, $tabAlign) {
        // Saut de ligne
//        $this->Ln(5);
...
//        $this->Cell(array_sum($w), 0, '', 'T');
    ...
    /* Colored table */
	function FancyTableg($header,$headerBD, $data)
	{
