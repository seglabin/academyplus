...
//        $this->Image('../img/entete.jpg', 5, 5, 100, 17);
...
//        $this->SetDrawColor(102, 405, 145);
        $this->MultiCell(0, 20, utf8_decode('ACADEMY PLUS       '), 0, 'C', FALSE);
        
$this->SetFont('Arial', '', 10);
  $this->MultiCell(0, 5, utf8_decode('COLLEGE LA REFERENCE                           Adresse : Gbèdjromèdé'), 0, 'L', $fill);
  
$this->SetFont('Arial', '', 10);
  $this->MultiCell(0, 5, utf8_decode('IFU : 3201201184616                 C/1249 Gbèdjromèdé 2 COTONOU'), 0, 'L', $fill);
$this->SetFont('Arial', '', 10);
  $this->MultiCell(0, 5, utf8_decode('RCCM :                                                           Contact : 95710071'), 0, 'L', $fill);
  $this->MultiCell(0, 5, utf8_decode('e-MCF   : EM01253596                        groupescolairelareference1@gmail.com'), 0, 'L', $fill);
 $this->ln(5);
$this->SetFont('Arial', '', 10);
        
       if($_SESSION["titre"]!='') $this->MultiCell(150, 5, utf8_decode($_SESSION["titre"]), 0, 'C', FALSE);

        $this->MultiCell(0, 10, utf8_decode('Etab : '.$_SESSION["libetab"]), 0, 'L', FALSE);
        $this->MultiCell(0, -10, utf8_decode('Année : '. $_SESSION["libannesco"]), 0, 'R', FALSE);
        $this->MultiCell(0, 15, '', 0, 'L', FALSE);
